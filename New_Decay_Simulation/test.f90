program simulation
   ...
   theta4 = theta_min + (theta_max - theta_min)*r  !Recoil 12C Polar Angle
   phi4 = phi_min + (phi_max - phi_min)*s   !Recoil 12C Azimuthal Angle 
...
elseif (e(1) == ee(2) .and. e(2) == ee(3) .and. e(3) == ee(1)) then
   ...
   e = (/e12,e23,e31/)
   !write(14,*)E1-E4-En1-En2-En3+(Ex-Eth)
