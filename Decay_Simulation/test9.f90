!Decay Simulation for 16O+12C at beam energy 95 MeV
program simulation
implicit none

real :: m1, m2, m3, m4
real :: E1, Ex, Eth, Ecm1, Ecm2, Ecm3, E3, E4, theta3, theta4, phi3, phi4, d2r, r2d, a , b , d , r , s, t, u
real :: P1(3), P2(3), P3(3), P4(3), En1(5000), En2(5000), En3(5000), EnSc(5000), EnO(5000), th(5000)
...
!System Info
m1 = 16.0 !Incoming Particle mass In amu
m2 = 12.0 !targer particle mass In amu
m3 = 12.0 !recoil particle mass In amu
m4 = 16.0 !scaterred particle mass In amu
...
if ((b**2. - 4.*a*d) .ge. 0.) then
    ...
    P3 = P1+P2-P4
    v_C = (P3/m3)  
    call pol_angles(v_C,theta3,phi3)
...
write(*,*)"min energy 16O", minval(EnSc), "max energy 16O", maxval(EnSc)
write(*,*)"min energy 12C", minval(EnO), "max energy 12C", maxval(EnO)
Write(*,*)"min theta 12C", minval(th), "max theta 12C", maxval(th)
