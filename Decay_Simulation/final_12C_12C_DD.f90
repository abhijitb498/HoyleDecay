!Decay Simulation for 12C+12C at beam energy 75 MeV
program simulation
implicit none

real :: m1, m2, m3, m4
real :: E1, Ex, Eth, Ecm1, Ecm2, Ecm3, E3, E4, theta3, theta4, phi3, phi4, d2r, r2d, a , b , d , r , s, t, u
real :: P1(3), P2(3), P3(3), P4(3), En1(5000), En2(5000), En3(5000), EnSc(5000), EnC(5000)
...
write(*,*)"min recoil 12c", minval(EnC), "max recoil 12c", maxval(EnC)
!Write(*,*)pol_angles(v_C)
